...
export default function SignUp({ onNavigate, onSignUp }) {
    ...
    return (
        <div className="min-h-screen bg-[#1c1c1c] flex items-center justify-center p-4 sm:p-8 font-sans">
            <div className="w-full max-w-[1000px] h-[700px] flex rounded-xl overflow-hidden shadow-2xl bg-white border border-[#2d2d2d]">
                ...
                {/* Right Side - Image */}
                <div className="hidden md:flex w-1/2 bg-[#f4f8ff] items-center justify-center p-8">
                    <img
                        src="/src/Images/cuate.png"
